...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { comentario: @movement.comentario, fecha: @movement.fecha } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { comentario: @movement.comentario, fecha: @movement.fecha } }
